...
public class PaymentService {
	...
	public PaymentService(PaymentRepository paymentRepository, IdempotencyService idempotencyService,PaymentLockService paymentLockService,PaymentEventProducer paymentEventProducer) {
